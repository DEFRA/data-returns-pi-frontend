...
module.exports = {
    ...
    getTransferOperations: process.env.NODE_ENV === 'localtest' ? testService.getTransferOperations : testService.getTransferOperations,
    getTransferOperationById: process.env.NODE_ENV === 'localtest' ? testService.getTransferOperationById : testService.getTransferOperationById,
    getMethods: process.env.NODE_ENV === 'localtest' ? testService.getMethods : testService.getMethods,
    getMethodById: process.env.NODE_ENV === 'localtest' ? testService.getMethodById : testService.getMethodById,
    getEwc: process.env.NODE_ENV === 'localtest' ? testService.getEwc : testService.getEwc,
    getEwcActivityById: process.env.NODE_ENV === 'localtest' ? testService.getEwcActivityById : testService.getEwcActivityById,
    getEwcChapterById: process.env.NODE_ENV === 'localtest' ? testService.getEwcChapterById : testService.getEwcChapterById,
    getEwcSubChapterById: process.env.NODE_ENV === 'localtest' ? testService.getEwcSubChapterById : testService.getEwcSubChapterById,
